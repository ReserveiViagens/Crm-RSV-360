...
1. Configure variáveis de ambiente reais (SMTP, Evolution API, Gateway Pix, VOUCHER_SECRET, SESSION_SECRET)
2. Substitua in-memory stores por PostgreSQL persistente
3. Integre monitoramento (Sentry/Datadog) consumindo os alertas de `GET /api/admin/alerts`
