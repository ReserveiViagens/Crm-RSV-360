...
/* ─────────────────────────────────────────────────────────────────────────────
   ...
   Enum schemas are derived from shared const arrays — single source of truth.
   ───────────────────────────────────────────────────────────────────────────── */

/* ─── Enum schemas (derived from shared const arrays) ───────────────────── */

export const PageStatusSchema = z.enum(PAGE_STATUSES);
export const PageSectionSchema = z.enum(PAGE_SECTIONS);
export const PageAccessSchema = z.enum(PAGE_ACCESSES);
export const HeroTypeSchema = z.enum(HERO_TYPES);
export const MediaTypeSchema = z.enum(MEDIA_TYPES);
export const MediaPlacementSchema = z.enum(MEDIA_PLACEMENTS);
...
export const createPageValidator = z.object({
  ...
  access: PageAccessSchema.default("public"),
...
export const pageIdParamValidator = z.object({ id: uuidParam });
export const pageSlugParamValidator = z.object({ slug: slugParam });
...
export const updateSettingsValidator = z
  .object({
    ...
    heroType: HeroTypeSchema.optional(),
...
export const mediaQueryValidator = z
  .object({
...
export const mediaUpdateValidator = z
  .object({
...
export const mediaIdParamValidator = z.object({ id: uuidParam });

export const mediaSwapValidator = z.object({ id: uuidParam });
...
export const auditQueryValidator = z
  .object({
