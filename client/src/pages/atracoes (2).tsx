...
export default function AtracoesPage() {
  const { data: cmsContent } = useCMSContent("atracoes")
  const { data: galleryData } = usePageGallery("atracoes")
    ...
    >
      <div
        ...
        style={{
          ...
          position: "relative",
          overflow: "hidden",
          background: getCMSHeroBg(cmsHero, "url('https://hebbkx1anhila5yf.public.blob.vercel-storage.com/O-que-fazer-em-Caldas-Novas-alem-dos-parques-.jpg-hggVCc4sV9K9nxiHfEglNOYL1NO3Mr.jpeg') center/cover no-repeat"),
        }}
      >
        <div style={{
        ...
        <div style={{ maxWidth: 780, margin: "0 auto", position: "relative", zIndex: 1 }}>
          ...
          >
            {cmsHero?.headline ?? <>Descubra as Melhores<br /><span style={{ color: "#4ADE80" }}>Atrações de Caldas Novas</span></>}
          </h1>

          <p style={{ fontSize: 16, opacity: 0.88, margin: "0 0 28px", lineHeight: 1.6, maxWidth: 540 }}>
            {cmsHero?.subheadline ?? "Parques termais, natureza exuberante, cultura e muito mais — guia completo com recomendações de IA para cada perfil de viajante."}
          </p>
      ...
      <PageGallery images={galleryImages} video={galleryVideo} title="Galeria de atrações e passeios" />
    </CatalogPageShell>
  )
}
