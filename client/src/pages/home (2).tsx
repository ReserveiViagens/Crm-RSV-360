    ...
    <div className="rsv-page">
      ...
      <div style={{
        ...
        <div style={{ position: "relative", maxWidth: 780, margin: "0 auto", textAlign: "center" }}>
          ...
          <h1 data-cms-section="hero" style={{ fontSize: "clamp(26px, 5vw, 42px)", fontWeight: 900, color: "#fff", lineHeight: 1.15, marginBottom: 16, letterSpacing: -1 }}>
            {cmsHero?.headline ?? <>Ingressos, Hotéis e Excursões<br /><span style={{ color: "#F57C00" }}>com até 70% OFF</span></>}
          </h1>

          <p style={{ fontSize: "clamp(14px, 2.5vw, 16px)", color: "rgba(255,255,255,0.8)", maxWidth: 560, margin: "0 auto 32px", lineHeight: 1.7 }}>
            {cmsHero?.subheadline ?? "Reserve parques aquáticos, hotéis termais e excursões em grupo com os melhores preços. Suporte via WhatsApp e parcele em até 12x!"}
          </p>
