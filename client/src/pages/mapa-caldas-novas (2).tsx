...
export default function MapaCaldas() {
  const { data: cmsContent } = useCMSContent("mapas")
  ...
  return (
    ...
    >
      ...
      <div data-cms-section="hero" style={{
        background: getCMSHeroBg(cmsHero, "linear-gradient(135deg, #1E3A5F 0%, #1565C0 60%, #0D47A1 100%)"),
        ...
        <div style={{ textAlign: "center", position: "relative", zIndex: 1 }}>
          ...
          <h1 data-testid="text-page-title" style={{ color: cmsHero?.textColor ?? "#fff", fontSize: 21, fontWeight: 900, margin: "0 0 8px", lineHeight: 1.25 }}>
            {cmsHero?.headline ?? "Explore Caldas Novas no Mapa Interativo"}
          </h1>
          <p style={{ color: "rgba(255,255,255,0.8)", fontSize: 13, margin: "0 0 6px", lineHeight: 1.5 }}>
            {cmsHero?.subheadline ?? "Toque nos pins para ver detalhes, rotas e reservar"}
          </p>
