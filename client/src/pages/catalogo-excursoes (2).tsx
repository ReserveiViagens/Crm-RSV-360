...
const EXCURSOES: Excursao[] = [
  ...
  {
    id: "19",
    titulo: "Caldas & Parques — Saída Curitiba",
    destino: "Caldas Novas",
    estado: "GO",
    cidadeSaida: "Curitiba",
    estadoSaida: "PR",
    cepSaida: "80000-000",
    dataPartida: "2026-07-18",
    dataRetorno: "2026-07-23",
    diasDuracao: 6,
    preco: 1190,
    precoOriginal: 1550,
    vagasTotal: 44,
    ...
    imagem: "https://images.unsplash.com/photo-1566073771259-6a8506099945?w=600&q=80",
    tag: "Férias Julho",
    slug: "caldas-parques-saida-curitiba",
    descricao: "Saindo de Curitiba rumo às termas de Caldas Novas. 2 parques aquáticos, hotel 4 estrelas e seguro viagem inclusos.",
  },
  {
    id: "20",
    titulo: "Termas Goianas — Saída Salvador",
    destino: "Rio Quente",
    estado: "GO",
    cidadeSaida: "Salvador",
    estadoSaida: "BA",
    cepSaida: "40000-000",
    dataPartida: "2026-08-01",
    dataRetorno: "2026-08-06",
    diasDuracao: 6,
    preco: 1320,
    precoOriginal: 1680,
    vagasTotal: 36,
    ...
    avaliacoes: 22,
    categoria: "aventura",
    inclui: ["Transporte Aéreo", "Hotel 4★", "Café da manhã", "Hot Park", "Transfer", "Seguro"],
    imagem: "https://images.unsplash.com/photo-1530789253388-582c481c54b0?w=600&q=80",
    tag: "Voo Incluso",
    slug: "termas-goianas-saida-salvador",
    descricao: "Partindo de Salvador de avião para o maior complexo termal do Brasil. Hot Park, hotel 4 estrelas e transfer inclusos.",
  },
]
...
export default function CatalogoExcursoes() {
  const { data: cmsContent } = useCMSContent("catalogo")
  ...
  return (
    <div className="rsv-catalog-shell" style={{ minHeight: "100vh", background: "#F8F9FA" }} data-testid="catalogo-excursoes">
      ...
      <div data-cms-section="hero" style={{
        background: getCMSHeroBg(cmsHero, "linear-gradient(135deg, #0F1F38 0%, #1E3A5F 100%)"),
        ...
        <div style={{ position: "relative", maxWidth: 780, margin: "0 auto", textAlign: "center" }}>
          ...
          <div style={{ marginBottom: 16 }}>
            <h1 data-testid="text-page-title" style={{ fontSize: "clamp(26px, 5vw, 38px)", fontWeight: 900, color: cmsHero?.textColor ?? "#fff", marginBottom: 6, letterSpacing: -0.5 }}>
              {cmsHero?.headline ?? "Catálogo de Excursões"}
            </h1>
            <p style={{ fontSize: "clamp(14px, 2.5vw, 16px)", color: "rgba(255,255,255,0.65)" }}>
              {cmsHero?.subheadline ?? `${EXCURSOES.length} excursões disponíveis · ${totalVagas} vagas abertas · A partir de R$ ${precoMin}`}
            </p>
          </div>
