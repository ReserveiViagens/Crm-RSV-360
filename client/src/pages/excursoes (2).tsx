...
export default function Excursoes() {
  const { data: cmsContent } = useCMSContent("excursoes")
  const { data: galleryData } = usePageGallery("excursoes")
    ...
    >
      ...
      <section
        ...
        style={{
          ...
          background: getCMSHeroBg(cmsHero, "#0F1F38"),
          minHeight: 520,
        }}
      >
        <div style={{
        ...
        <div style={{
          ...
          <h1 data-testid="text-page-title" style={{
            ...
            color: cmsHero?.textColor ?? "#fff", lineHeight: 1.15, marginBottom: 14, letterSpacing: -1,
          }}>
            {cmsHero?.headline ?? <>Excursões em grupo com<br /><span style={{ color: "#F59E0B" }}>tudo incluso</span></>}
          </h1>
          ...
          <p style={{
            ...
            {cmsHero?.subheadline ?? "Viaje com conforto e segurança para Caldas Novas e Rio Quente. Ônibus, hotel, passeios e guia — tudo organizado para você."}
          </p>
      ...
      <PageGallery images={galleryImages} video={galleryVideo} title="Galeria de excursões e destinos" />
    </CatalogPageShell>
