...
export default function ViagensGrupoPage() {
  const { data: cmsContent } = useCMSContent("grupos")
  ...
  return (
    <div style={{ background: "#F9FAFB", minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      <div
        ...
        style={{
          background: getCMSHeroBg(cmsHero, "linear-gradient(135deg, #1e3a5f, #2563EB)"),
          padding: "14px 16px",
          color: "#fff",
        }}
      >
        ...
        >
          ...
          <div style={{ flex: 1 }}>
            <h1 style={{ fontSize: 16, fontWeight: 700, margin: 0 }}>{cmsHero?.headline ?? "Excursão em Grupo"}</h1>
            <div style={{ display: "flex", alignItems: "center", gap: 6, marginTop: 2, flexWrap: "wrap" }}>
              <span style={{ fontSize: 11, opacity: 0.85 }}>{cmsHero?.subheadline ?? "Saída • Destino • Roteiros • Adicionais"}</span>
