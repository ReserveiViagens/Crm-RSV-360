...
export default function CaldasAIPage() {
  const { data: cmsContent } = useCMSContent("caldas-ai")
  ...
  return (
    <div className="rsv-subpage" style={{ background: "#F8FAFC", minHeight: "100vh" }} data-testid="page-caldas-ai">
      ...
      <div data-cms-section="hero" style={{
        background: getCMSHeroBg(cmsHero, "linear-gradient(135deg, #1e3a5f 0%, #0D47A1 55%, #2563EB 100%)"),
        ...
        <div style={{ textAlign: "center", position: "relative", zIndex: 1 }}>
          ...
          <h1 style={{ color: "#fff", fontSize: 21, fontWeight: 900, margin: "0 0 8px", lineHeight: 1.25 }}>
            {cmsHero?.headline ?? "Caldas AI — seu guia pessoal de Caldas Novas"}
          </h1>

          <p style={{ color: "rgba(255,255,255,0.82)", fontSize: 13, margin: "0 0 20px", lineHeight: 1.5 }}>
            {cmsHero?.subheadline ?? (profile ? "Recomendações personalizadas com IA para sua viagem" : "Pergunte qualquer coisa sobre Caldas Novas e Rio Quente")}
          </p>
